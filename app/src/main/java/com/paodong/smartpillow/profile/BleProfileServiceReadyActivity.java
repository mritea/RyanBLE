package com.paodong.smartpillow.profile;
...
import com.paodong.smartpillow.scanner.ScannerFragment;
...
public abstract class BleProfileServiceReadyActivity<E extends BleProfileService.LocalBinder> extends AppCompatActivity implements
    ...
    /**
     * Called when activity binds to the service. The parameter is the object returned in method in your service. The method is
    ...
    protected final void setUpView() {
        // set GUI
        //getSupportActionBar().setDisplayHomeAsUpEnabled(true); // 不显示返回键
    ...
    private void showDeviceScanningDialog(final UUID filter) {
        DebugLogger.d("zhfzhf", "showDeviceScanningDialog UUID filter="+filter);
